...
namespace MakeBoldSpark.Core.Providers
{
    ...
    {
        private readonly MakeBoldSparkCoreDbContext _dbContext;
        ...
        public SyndicationProvider(MakeBoldSparkCoreDbContext dbContext, IStorageProvider storageProvider)
        {
