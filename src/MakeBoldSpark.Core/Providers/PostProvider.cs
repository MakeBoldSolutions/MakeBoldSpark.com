...
using MakeBoldSpark.Core.Extensions;
using MakeBoldSpark.Core.Models;
...
public class PostProvider : IPostProvider
{
    ...
    public PostProvider(MakeBoldSparkCoreDbContext db, Interfaces.ICategoryProvider categoryProvider, IConfiguration configuration)
    {
        _db = db;
