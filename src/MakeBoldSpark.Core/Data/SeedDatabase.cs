using MakeBoldSpark.Core.Helpers;
using MakeBoldSpark.Core.Infrastructure.BaseClasses;

namespace MakeBoldSpark.Core.Data;

public class SeedDatabase : IDisposable
{
    private readonly MakeBoldSparkCoreDbContext _context;

    public SeedDatabase(MakeBoldSparkCoreDbContext context)
    {
        _context = context;
    }
    ...
    public async Task SeedDatabaseAsync()
    {
        ...
        try
        {
            ...
            _context.SaveChanges();
            // Recipe categories and recipes are now seeded via RecipeDbContext in MakeBoldSpark.Recipe.
