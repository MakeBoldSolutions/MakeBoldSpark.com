...
using MakeBoldSpark.Core.Interfaces;
using MakeBoldSpark.Core.Providers;

namespace MakeBoldSpark.Core.Extensions;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddBlogDatabase(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        if (section.GetValue<string>("DbProvider") == "SQLite")
            services.AddDbContext<MakeBoldSparkCoreDbContext>(o => o.UseSqlite(conn));
