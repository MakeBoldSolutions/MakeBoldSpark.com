...
namespace MakeBoldSpark.Core.Infrastructure.Logging;
...
public static class LoggingUtility
{
    public static void ConfigureLogging(WebApplicationBuilder builder, string applicationName)
    {
        ...
        string logPath = builder.Configuration.GetValue<string>("MakeBoldSpark:LogFilePath")
                         ?? $"C:\\websites\\MakeBoldSpark\\logs\\{applicationName}-log-.txt";
