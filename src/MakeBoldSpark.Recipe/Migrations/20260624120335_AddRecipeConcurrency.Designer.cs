...
namespace MakeBoldSpark.Recipe.Migrations
{
    ...
    [Migration("20260624120335_AddRecipeConcurrency")]
    partial class AddRecipeConcurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.RecipeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.RecipeComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.RecipeImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.Recipe", b =>
                {
                    b.HasOne("MakeBoldSpark.Recipe.Data.RecipeCategory", "RecipeCategory")
                        .WithMany("Recipe")
            ...
            modelBuilder.Entity("MakeBoldSpark.Recipe.Data.RecipeComment", b =>
                {
                    b.HasOne("MakeBoldSpark.Recipe.Data.Recipe", "Recipe")
